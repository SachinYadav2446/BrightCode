  ...
  const sections = [
    {
      ...
      content: "BrightCode is a high-performance ecosystem designed for the next generation of engineers. We provide an end-to-end platform for collaborative development, competitive programming, and professional networking within specialized factions."
    },
    {
      id: 'start',
      icon: <Rocket size={24} />,
    ...
    <div className="user-module-page">
      <nav className="module-nav">
        ...
        <div className="nav-brand">
           ...
           <span>BrightCode / User Module</span>
        </div>
      </nav>
      ...
      <div className="module-layout">
        ...
        <main className="module-main">
          ...
          >
            ...
            <p>Your comprehensive guide to navigating, competing, and excelling in BrightCode.</p>
          </motion.div>
